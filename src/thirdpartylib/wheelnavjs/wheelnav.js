...
wheelnav = function (divId, raphael, divWidth, divHeight) {
    ...
    this.titleFont = '100 24px Lato, Charcoal, sans-serif';
    this.titleAttr = null;
...
$("#divWheelnav").attr("data-wheelnav-navangle","0");
$("#divWheelnav").attr("data-wheelnav-marker","");
$("#divWheelnav").attr("data-wheelnav-markerpath","TriangleMarker");
$("#divWheelnav").attr("class","img-responsive right-md center-block");
$("#divWheelnav").attr("data-wheelnav","");
$("#divWheelnav").attr("data-wheelnav-keynav","");
$("#divWheelnav").attr("data-wheelnav-keynavonlyfocus","");
$("#divWheelnav").attr("data-wheelnav-keynavdowncode","37");
$("#divWheelnav").attr("data-wheelnav-keynavdowncodealt","40");
$("#divWheelnav").attr("data-wheelnav-keynavupcode","39");
$("#divWheelnav").attr("data-wheelnav-keynavupcodealt","38");
$("#divWheelnav").attr("data-wheelnav-slicepath","WheelSlice");
$("#divWheelnav").attr("data-wheelnav-colors","#FF5257,#40A5A2, #988FD1, #0A99FF");
